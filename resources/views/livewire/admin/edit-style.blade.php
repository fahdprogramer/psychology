    ...
    <form wire:submit="save">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <div class="flex justify-center items-center">
                <h1 class="font-bold text-3xl mb-8 text-center">تعديل نموذج البدلة</h1>
            </div>
            <div class="w-full ">
                <h1 class="font-bold mr-2">معاينة:</h1>
                <div class="flex justify-center">
                    <div class="relative h-[250px] md:h-[300px] w-60">
                        ...
                        @if ($style_images->count() > 1)
                            ...
                            <button wire:click="GoBack" type="button"
                                ...
                                <span
                                    ...
                                    <svg class="w-4 h-4 text-blue-400 dark:text-gray-800 rtl:rotate-180"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2  text-xs lg:text-sm">
            ...
            <div class="px-4">
                ...
                <h1 class="font-bold mt-5">إختر {{ $radio == 'size' ? 'الأحجام' : 'الأعمار' }} المتوفرة لهذا النموذج
                </h1>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    @foreach ($style->images as $item)
                        <div class="relative">
                            <img src="{{ Storage::url($item->name) }}" class="w-full h-56 rounded-xl"
                                alt="RoseLine Store">
                            <button type="button" wire:click='delete_photo({{ $item->id }})'
                                class="font-bold text-red-600 bg-white rounded-full p-1 py-0.5 border-2 hover:shadow-lg hover:shadow-orange-500 hover:bg-red-200 border-red-500 absolute top-2 left-2">X</button>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="bg-slate-200 mt-5 rounded-3xl border border-slate-400 py-2 cursor-pointer {{ $errors->isEmpty() ? 'animate__animated animate__fadeInDown' : '' }}"
                    ...
                    <div class="flex justify-center ">
                        <label for="upload">
                            ...
                            <input type="file" class="hidden" wire:model="photos" name="image" id="upload"
                                multiple>
                            <h1 class="text-center text-slate-400 text-sm font-semibold ">قم بإضافة صور ان كنت تريد
                            </h1>

<div>
    <form wire:submit="register">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button type="submit"
                class="text-gray-900 py-2 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 shadow-lg shadow-lime-500/50 rounded-lg text-sm px-9  text-center  font-bold w-fit mx-auto">إضافة
                التخصص</button>

<div class="px-1 sm:px-2 md:px-5 lg:px-10 xl:px-20 min-h-screen py-28 pb-40 sm:pb-20" wire:poll>
    ...
    @else
        ...
        <div class="flex justify-end">
            <button onclick="myFunction()" type="button"
                ...
                حذف كل الإشعارات
                <svg aria-hidden="true" class="w-5 h-5 mr-3" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"
    ...
    @foreach ($notifications as $item)
        <div class="bg-teal-100 bg-opacity-20 rounded-xl mb-3 pb-1">
            <div class="flex justify-between  items-center p-4 pb-0">
                ...
                <button
                    onclick="                      Swal.fire({
                                            title: 'هل أنت متأكد!',
                                            text: 'ستقوم بحذف الإشعار!',
                                            icon: 'تنبيه',
                                            showCancelButton: true,
                                            confirmButtonColor: '#3085d6',
                                            cancelButtonColor: '#d33',
                                            cancelButtonText: 'إلغاء',
                                            confirmButtonText: 'نعم قم الحذف!'
                                        }).then((result) => {
        ...
        "
                    class="p-1 rounded-full bg-slate-300">

            ...
            <tr class="{{($loop->iteration % 2 == 0)?'bg-lime-600':'bg-lime-500'}} bg-opacity-40 border-b border-lime-400">
                ...
                <td class="px-6 py-4 ">
                    ...
                    <td class="px-6 py-4 ">
                        ...
                        <button wire:click='info({{$item->id}})'  class="text-black mx-auto bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm p-1  text-center "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 text-lime-100">

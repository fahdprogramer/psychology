<div class="py-10 my-3 px-4 bg-slate-50 bg-opacity-40 rounded-3xl">
        ...
        <tbody class="text-black">
            ...
            <tr class="{{($loop->iteration % 2 == 0)?'bg-blue-600':'bg-blue-500'}} bg-opacity-40 border-b border-blue-400">
                ...
                <td class="px-6 py-4 ">
                    ...
                    <button type="button" class="text-black mx-auto bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">الإنتقال الى الرسائل</button>
                </div>
                    </td>
            </tr>
            @endforeach

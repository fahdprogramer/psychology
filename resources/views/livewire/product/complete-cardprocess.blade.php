<div>
    ...
    <div class="px-4 min-h-screen pt-2 pb-20 lg:pb-0 lg:px-20">
            ...
            <div class="flex justify-center items-center">
                    ...
                    <div class="col-span-1 grid grid-cols-2 bg-[#d7c9b76f] rounded-2xl border-2 border-l-rose-300">
                        <div class="flex ">
                            ...
                            <div class="w-full "><img src="{{ Storage::url($style->images->first()->name) }}"
                                    id="myImg" class="rounded-3xl object-cover w-full h-60"
                        ...
                        <div class="py-2 px-2   border-l ">
                            ...
                            <a href="/" class="">
                                <h1 class="text-lg my-4 truncate font-semibold uppercase">المقاس: {{ $this->convertSize($size) }}
                                </h1>
                            </a>
                            <h1 class="text-center mb-4">{{ $style->product->price * $quantity }} دج
                            </h1>
                            <div class=" justify-around my-4 items-center">

                                <div class="flex justify-center items-center">
                                    <svg wire:click='increaseNbr'
                                    ...
                                    <span class="mx-1 text-xl">{{ $quantity }}</span>
                                    <svg wire:click='decreaseNbr'
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="w-10 h-10 cursor-pointer">
                                        <path fill-rule="evenodd"
                            ...
                            <div>
                                <h1 class="text-red-700 text-center">بقي في
                                    المخزون <span class="font-bold"> {{ $style->{'nbr_'.$size} }} قطع</span> </h1>
                            </div>
                        </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-3 py-6">
                ...
                <div class="">
<img src="/images/other/1.jpg" class="w-full rounded-xl" alt="RoseLine">
                </div>
            </div>
